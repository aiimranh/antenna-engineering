...
lifetime=s:rebuild
result=s:1
files=s:power (f=5.5)_h_1,1.m3d
...
lifetime=s:rebuild
result=s:1
files=s:power (f=5.5)_e_1,1.m3d
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Power Flow\power (f=5.5) [1]
files=s:power (f=5.5)_1,1.m3d
files=s:power (f=5.5)_1,1_m3d.rex
ylabel=s:power (f=5.5) [1]
